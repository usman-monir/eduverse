...
import { getAvailableTutors, createSessionSlotRequest, getMySessions } from "@/services/api";
...
const RequestSlot = () => {
  ...
  const isAccessRestricted = user?.canRequestSlots === false;
  ...
  const checkUserBookingForDate = async (date: Date) => {
    ...
    try {
      ...
      // Check if user has any booking on the selected date
      const hasBooking = userBookings.some((booking: any) => {
  ...
  return (
    <DashboardLayout>
      <div className="max-w-full mx-auto space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold mb-2">Request a 1-Hour Session</h1>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-red-700">
                    Your ability to request custom slots has been restricted by an administrator. 
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-amber-700 space-y-1">
                    <li>
                      • All sessions are <strong>1 hours long</strong>
                    </li>
                    <li>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2 p-3 bg-gray-50 border border-gray-200 rounded-md">
                    ...
                    <span className="text-sm font-medium">1 hours (fixed)</span>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <ul className="space-y-1">
                    ...
                    <li>• Submit your 1-hour session request</li>
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    <li>• Sessions are exactly 1 hours long</li>
