...
const Sidebar = () => {
  ...
  const studentNavItems = [
    ...
    { path: "/student/smart-quad-booking", label: "Smart Quad", icon: Users },
  ...
  const adminNavItems = [
    ...
    { path: "/admin/smart-quad-batches", label: "Smart Quad", icon: Users },
  ...
  return (
    <div className="h-full flex flex-col bg-white shadow-lg border-r border-gray-200">
      <div className="p-6 border-b border-gray-200">
        <h1 className="text-2xl font-bold text-blue-600">Score Smart LMS</h1>
